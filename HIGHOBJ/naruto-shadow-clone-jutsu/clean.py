...
def train_mode(data_path, model_out, camera_id):
    print(f"mode: train")
    print(f"data {data_path}")
    print(f"model_out {model_out}")
    print(f"camera {camera_id}")

def run_mode(model_path, threshold, camera_id):
    print(f"mode: run")
...
def main() -> None:
    ...
    if args.mode == "train":
        ...
        run_mode(model_path=args.mode, threshold=args.threshold, camera_id=args.camera)
